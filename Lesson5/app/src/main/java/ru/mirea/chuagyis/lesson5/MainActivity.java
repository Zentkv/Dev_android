package ru.mirea.chuagyis.lesson5;
...
import ru.mirea.chuagyis.lesson5.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < sensors.size(); i++) {
            ...
            sensorTypeList.put("Value", "Макс. диапазон: " + sensors.get(i).getMaximumRange());
